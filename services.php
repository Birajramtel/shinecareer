...
<section class="main-breadcrumb">
    <div class="container px-0">
        <div class="page-breadcrumb">
            <h4><span>Home</span> > <span>Our Services</span></h4>
        </div>
    </div>
</section>
        ...
        <div class="row">
            <div class="col-md-6 px-0">
                <div class="service-image">
                    ...
                    <img src="https://i.ibb.co/brVxYRK/services-1.png" alt="">
                    <div class="overlay"></div>
                    <div class="overtext d-flex justify-content-center align-items-center">
            ...
            <div class="service-exerpt">
                ...
                <button type="button" class="btn b_color text-capitalize"><a href="student_counselling.php">Explore</a></button>
            </div>
            </div>
        </div>
<br>
        <div class="row">
        <div class="col-md-6 order-md-12 px-0">
                <div class="service-image">
                    <!-- <img src="../images/services-1.png" alt=""> -->
                    <img src="./images/services-2.png" alt="">
                    <div class="overlay"></div>
                    <div class="overtext d-flex justify-content-center align-items-center p-4">
                        <h4>University Application Process Guidance </h4>
                    </div>
                </div>
            </div>
...
Our support doesn’t end there. We will keep pushing you in the preparation of the interviews and the visa process. Our formal responsibility ends only when you reach and settle in your destination. However, that doesn’t imply we will get disconnected. Our help and cooperation will always be with you.
                ...
                <button type="button" class="btn b_color text-capitalize"><a href="language_classes.php">Explore</a></button>
            </div>
            </div>
...
<br>
        <div class="row">
            ...
            <div class="col-md-6 px-0 order-md-12">
                <div class="service-image">
                    <!-- <img src="../images/services-1.png" alt=""> -->
