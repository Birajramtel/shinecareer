...
<section class="brochure-download my-5">
    <div class="container">
        ...
        <div class="row  my-4">
            ...
            <div class="col-md-4">
                <button type="button" class="btn btn-lg float-right button_color download-btn text-capitalize"><a href="./images/services-1.png" download>Click to download</a></button>
            </div>
        </div>
    </div>
</section>